...
export const theme = {
    ...
    authTitle:              colors.black,
    authSubTitle:           colors.grey_1,
    checkedLabel:           colors.grey_1,
    uncheckedLabel:         colors.grey_0,
    buttonTextTitle:        colors.blue,
    inquiryTitle:           colors.black,
